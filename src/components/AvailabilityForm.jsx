...
/**
 * AvailabilityForm component for employees to create availability slots.
 *
 * @param {Function} onSlotCreated - Callback when a slot is successfully created
 */
function AvailabilityForm({ onSlotCreated }) {
  // Generate time options for working hours (08:00-16:00, 30-min intervals)
  ...
  const handleSubmit = async (e) => {
    ...
    // Validate start time allows for 30-min slot within working hours
