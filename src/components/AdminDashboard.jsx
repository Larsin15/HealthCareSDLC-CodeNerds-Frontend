...
/**
 * AdminDashboard - Admin-only dashboard for employee management.
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(
        ...
        {
          ...formData,
          roles: ["EMPLOYEE"], // Always register as EMPLOYEE
        }
      );

      console.log("Employee registration successful:", response.data);
      setSuccess(
        `Employee account created successfully for ${formData.username}!`
      );
