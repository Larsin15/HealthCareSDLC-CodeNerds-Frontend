...
// Styled components for booking confirmation
...
/**
 * BookingConfirmation component displays the successful booking details.
 * Shows appointment information and provides navigation options.
 */
function BookingConfirmation() {
  ...
  // If no appointment data, show message
  if (!appointment) {
    return (
