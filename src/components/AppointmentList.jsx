...
// Styled components for appointment list
...
/**
 * AppointmentList component displays a list of appointments.
 * Supports cancellation for appointments that can be cancelled.
 *
 * @param {Array} appointments - List of appointment objects
 * @param {Function} onCancelSuccess - Callback when cancellation succeeds
 * @param {boolean} showPatientName - Whether to show patient name (for employee view)
 */
