...
/**
 * AvailabilityCalendar component displays available appointment slots using react-big-calendar.
 * Patients can browse slots in multiple views and select slots to book appointments.
 */
